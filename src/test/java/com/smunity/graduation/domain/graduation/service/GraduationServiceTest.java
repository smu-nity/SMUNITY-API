...
public class GraduationServiceTest {
    ...
    public void getGraduationCriteriaTest() {
        ...
        GraduationResponseDto graduationCriteria = graduationService.getGraduationCriteria();
    ...
    public void getRecommendMajorISubjects() {
        ...
        List<SubjectResponseDto> result = graduationService.getRecommendSubjects("major_i", 3);
    ...
    public void getRecommendMajorSSubjects() {
        ...
        List<SubjectResponseDto> result = graduationService.getRecommendSubjects("major_s", 3);
    ...
    public void getRecommendCultureSubjects() {
        ...
        List<SubjectResponseDto> result = graduationService.getRecommendSubjects("culture", 3);
    ...
    public void getRecommendCultureBSubjects() {
        ...
        List<SubjectResponseDto> result = graduationService.getRecommendSubjects("culture_b", 3);
    ...
    public void getRecommendCultureESubjects() {
        ...
        List<SubjectResponseDto> result = graduationService.getRecommendSubjects("culture_e", 3);
    ...
    public void getRecommendCultureSSubjects() {
        ...
        List<SubjectResponseDto> result = graduationService.getRecommendSubjects("culture_s", 3);
