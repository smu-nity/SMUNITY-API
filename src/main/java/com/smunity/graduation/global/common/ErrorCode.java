...
public enum ErrorCode implements BaseErrorCode {
    ...
    // qna 관련 에러
    AUTHOR_NOT_MATCHED(HttpStatus.FORBIDDEN, "QUESTION403", "작성자가 일치하지 않습니다."),
    QUESTION_NOT_FOUND(HttpStatus.NOT_FOUND, "QUESTION404", "해당 질문이 없습니다."),
    AUTHOR_IS_NOT_STAFF(HttpStatus.FORBIDDEN, "ANSWER403", "스태프가 아닙니다."),
    ANSWER_NOT_FOUND(HttpStatus.NOT_FOUND, "ANSWER404", "해당 답변이 없습니다."),
